...
Use complex line plot to visualize up to 6 time series with many points. The most typical example is to show data with time granularity of 1 day among the years (mean day temperature in the course of 16 months). 
