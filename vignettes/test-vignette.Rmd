...
scatter4 <- scatter_plot(p, p$bill_depth_mm, p$bill_length_mm, p$species, 5, 10, c("bill depht", "in mm"), c("bill length", "in mm"), "Legend") %>%
...
join_plots(scatter1, scatter2, scatter3,
           scatter4, scatter5,
