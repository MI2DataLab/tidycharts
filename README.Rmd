...
~~You can install the released version of tidycharts from [CRAN](https://CRAN.R-project.org) with:~~ The package is going to be deployed to CRAN, so that the installation process will look like:
...
```
![example column chart](https://raw.githubusercontent.com/SawickiBartosz/tidycharts/main/man/figures/README-example-columns-1.svg)
