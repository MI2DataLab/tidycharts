...
# ) %>% show()
# barchart_plot(data, data$city, groups, groups, styles = styles) %>% show()

#barchart_plot_normalized(data, data$city, groups, groups) %>% show() # obwód maskującego prostokąta renderuje się tylko w Rstudio. Po zapisaniu do pliku wygląda na całkowicie biały
